...
public class SaveTrip extends CommandUseCase<TripDTO, SaveTrip.Err> {
    ...
    @Override
    protected Outcome<Err> execute(TripDTO tripDTO) {
        // Attributes
        // -- create
    ...
    private ID getTripBookId(TripDTO tripDTO) {
