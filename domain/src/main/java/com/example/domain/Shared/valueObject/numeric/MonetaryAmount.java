...
public class MonetaryAmount implements Numeric<MonetaryAmount> {
    ...
    public MonetaryAmount abs() {
        return create(mAmount.abs()).getValue().orElseThrow(ImpossibleState::new);
    }
    ...
    // region calculator  --------------------------------------------------------------------------
    public static class Calculator implements Numeric.Calculator<MonetaryAmount, Result<MonetaryAmount, Err.Create>> {
        @Override
